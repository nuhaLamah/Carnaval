...
const regStore = (state = { storeList: [], address: {}, storeId: 0, pageNumber: 1, totalPages: 1, acceptedStores: 0, totalStores: 0, filterTerm: '', storeInfo: null, isInValid: false, isDone: false, isError: false, isLoading: false }, action) => {
    switch (action.type) {
        case 'REG_STORE':
